...
public class Büchershop_Verkauf extends JFrame {//Klasse Büchershop_Verkauf
    ...
    public Büchershop_Verkauf() {   //Konstruktor + Fenster
        ...
        einnahmeliste.setModel(Variante); //Modell + Liste
    ...
    private void verkaufenButton(ActionEvent e) {  //Fügt Objekt der JList hinzu mit den ausgewählten Attributen + Exception handling wenn etwas nicht ausgefüllt wird, wodurch ein Fehlerfenster aufkommt
        try {
            ...
            Buch Verkauft = new Buch(Titel, Genre, Autor, (int) Preis, Seitenanzahl);
            Variante.addElement(Verkauft);} catch (NumberFormatException ex) {
